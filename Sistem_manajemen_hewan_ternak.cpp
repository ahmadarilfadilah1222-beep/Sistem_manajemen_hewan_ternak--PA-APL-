...
// CRUD PENGAJUAN
// ==========================================
void tambahPengajuan(Pengajuan data[], int *jumlah) {
    bersihkanLayar();
    cout << "\n=== Tambah Pengajuan ===\n";
    cout << "ID        : "; cin >> data[*jumlah].id;
    cout << "Nama Hewan: "; cin.ignore(); getline(cin, data[*jumlah].nama);
...
void tampilPengajuan(Pengajuan data[], int jumlah) {
    bersihkanLayar();
    if (jumlah == 0) { cout << "Belum ada pengajuan.\n"; cout << "Tekan Enter..."; cin.ignore(); cin.get(); bersihkanLayar(); return; }
    cout << "\nData Pengajuan Masuk:\n\n";
    for (int i = 0; i < jumlah; i++) {
        cout << "+---------------------+\n";
        cout << "| ID    : " << setw(5) << data[i].id << "        |\n";
        cout << "| Nama  : " << left << setw(15) << data[i].nama << " |\n";
...
void updatePengajuan(Pengajuan data[], int jumlah) {
    bersihkanLayar();
    int cari; cout << "Masukkan ID pengajuan: "; cin >> cari;
    for (int i = 0; i < jumlah; i++) {
        if (data[i].id == cari) {
            cout << "Nama baru : "; cin.ignore(); getline(cin, data[i].nama);
...
void hapusPengajuan(Pengajuan data[], int *jumlah) {
    bersihkanLayar();
    int cari; cout << "Masukkan ID: "; cin >> cari;
    for (int i = 0; i < *jumlah; i++) {
        if (data[i].id == cari) {
...
bool login(vector<Akun>& users, bool &isAdmin) {
    bersihkanLayar();
    ...
    while (kesempatan > 0) {
        ...
        for (const auto& user : users) {
            if (user.username == u && user.password == p) {
                ...
                isAdmin = user.isAdmin; return true;
            }
        }
        kesempatan--;
...
int main() {
    ...
    do {
        ...
        if (menuAwal == 1) {
            ...
            sudahLogin = login(users, isAdmin);
            if (sudahLogin) {
                bersihkanLayar();
                if (isAdmin) {
                    // ===== MENU ADMIN =====
                    ...
                    do {
                        ...
                        else if (pilihan == 7) tampilPengajuan(pengajuan, jumlahPengajuan);
                        else if (pilihan == 8) cout << "Logout...\n";
                    ...
                    do {
                        ...
                        if (pilihan == 1) tambahPengajuan(pengajuan, &jumlahPengajuan);
                        else if (pilihan == 2) tampilData(ternak, jumlah);
                        else if (pilihan == 3) tampilPengajuan(pengajuan, jumlahPengajuan);
                        else if (pilihan == 4) updatePengajuan(pengajuan, jumlahPengajuan);
                        else if (pilihan == 5) hapusPengajuan(pengajuan, &jumlahPengajuan);
